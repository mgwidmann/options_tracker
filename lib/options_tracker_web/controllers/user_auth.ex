defmodule OptionsTrackerWeb.UserAuth do
  import Plug.Conn
  ...
  def log_out_user(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      OptionsTrackerWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  defp signed_in_path(conn), do: Routes.position_index_path(conn, :index)
end
